    ...
    <body>
        ...
        <div id="user">
            <div class="navbar">
                ...
                <a class="active" href="pending.php"><i class="fa fa-book"></i> Pending List</a>
              ...
              $id=$_SESSION['empid'];
                if($_SESSION['empid']!='' && $_SESSION['login']==true)
                {
                    ...
                    $con=new mysqli("localhost","root","","outpass");
                        ...
                        if($rows==0)
                        {
                            echo "<h2 style='margin-top:140px'><center><font color=red>No Records Found</font><strong></strong></center><h2>";
                        }
                        else
                        {
         				...
         				echo "<td class='td1'><a href='approve.php?oi=$data[outpassId]'  style='text-decoration:none;'><button class='btn' id='green'>Accept</button></a></td>
                                        <td class='td1'><a href='rej.php?oi=$data[outpassId]'  style='text-decoration:none;'><button class='btn' id='red'>Reject</button</a></td>
                                        <td class='td1'><a href='details2.php?oi=$data[outpassId]' id='myBtn'>View Details</a></td>
                                    	</tr>";
                                    }
                                    echo "</table>";
                           	echo "</div>";
